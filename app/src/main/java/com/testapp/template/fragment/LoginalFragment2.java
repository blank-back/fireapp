 ...
 */
public class LoginalFragment2 extends Fragment {
    ...
    public static LoginalFragment2 newInstance(String param1, String param2) {
        LoginalFragment2 fragment = new LoginalFragment2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_loginal2, container, false);
        acctext=view.findViewById(R.id.accname);
        acctext.setText(GlobalVariable.getInstance().getAccount());
        Button btn=view.findViewById(R.id.btn_leave);
